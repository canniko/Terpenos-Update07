...
export default function AdminOrdersClient({ adminId, activityLogs }: AdminOrdersClientProps) {
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-white/20">
                        <th className="text-left py-3 px-4 text-sm font-medium text-gray-300">Order ID</th>
